...
class PygView(object):
    ...
    def paint(self):
        ...
        #self.moab1 = MOAB(bounce_on_edge= True, pos = v.Vec2d(self.player1.pos.x, self.player1.pos.y), move=v.Vec2d(350, 0), max_age = 2)
    ...
    def run(self):
        ...
        while running:
            ...
            if pressed_keys[pygame.K_f]:
                m=v.Vec2d(1200,0)
                m.rotate(self.player1.move.get_angle())
                
                m+=self.player1.move
                MOAB(bounce_on_edge= True, pos = v.Vec2d(self.player1.pos.x, self.player1.pos.y),
...
if __name__ == '__main__':
    PygView(1440, 815, 60).run() # try PygView(800,600).run()
